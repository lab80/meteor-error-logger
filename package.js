...
Package.on_use(function (api, where) {
  ...
  api.use(['underscore', 'jquery', 'coffeescript', 'faisalman:ua-parser-js', 'http', 'ejson'], ['client']);
  api.addFiles('error_logger_client.coffee', 'client');
  api.export('ErrorLogger', 'client');

  api.use(['underscore', 'coffeescript', 'mongo', 'email', 'meteorhacks:picker', 'http', 'ejson'], ['server']);
